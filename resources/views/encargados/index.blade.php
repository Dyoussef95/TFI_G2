...
<div class="flex-shrink-0 p-3 text-white bg-primary" style="width: 280px;">
  ...
  <div class="container d-flex flex-column align-items-stretch flex-shrink-0 bg-dark text-white">
    ...
    <div class="scrollarea">
      <div class="col-12">
        <h4 class="mb-3">Lista de Encargados</h4>
        <a class="w-100 btn btn-primary btn-lg" href="{{ url('/encargados/create'); }}">Agregar Nuevo Encargado</a>
        <div class="col-12">    
            ...
            @foreach ($encargados as $encargado)                
                ...
                <td>{{ $encargado->legajo }}</td>
                <td>
                  <form action="{{ url('/encargados/'.$encargado->id); }}" method="POST">
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
                    <a class="btn btn-success btn-sm" href="{{ url('/encargados/'.$encargado->id.'/edit'); }}" role="button">Editar</a>
