        ...
        @csrf
          ...
          <div class="row g-3">
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="firstName" name="nombre" value="" required>
              </div>

              <div class="col-12">
              <label for="exampleFormControlTextarea1" class="form-label">Descripción</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" required name="descripcion"></textarea>
              </div>

              <div class="col-6">
                <label for="inicio" class="form-label">Inicio</label>
                <input type="date" class="form-control" id="firstName" name="inicio" value="" required>
              </div>

              <div class="col-6">
                <label for="inicio" class="form-label">Fin</label>
                <input type="date" class="form-control" id="firstName" name="fin" value="" required>
              </div>
              ...
              <select class="form-select" aria-label="Default select example" name="idEncargado" required>
                ...
                <option value="{{$encargado->id}}">{{$encargado->nombre}} {{$encargado->apellido}}</option>
                @endforeach
              </select>
              </div>
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Crear Proyecto</button>
        </form>
        <br>
      </div>
