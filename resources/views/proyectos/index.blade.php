  ...
  <div class="container d-flex flex-column align-items-stretch flex-shrink-0 bg-dark text-white">
    ...
    <div class="scrollarea">
      <div class="col-12">
        ...
        <a class="w-100 btn btn-primary btn-lg" href="{{ url('/proyectos/create'); }}">Agregar Nuevo Proyecto</a>
        <div class="col-12">    
            ...
            @foreach($proyectos as $proyecto)                
                ...
                <td>
                  @isset($proyecto->encargado)
                    {{ $proyecto->encargado->nombreCompleto() }}
                  @endisset
                </td>
                ...
                <td>
                  <form action="{{ url('/proyectos/'.$proyecto->id); }}" method="POST">
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
                    <a class="btn btn-info btn-sm" href="{{ url('/proyectos/'.$proyecto->id); }}" role="button">Ver Proyecto</a>
                    <a class="btn btn-success btn-sm" href="{{ url('/proyectos/'.$proyecto->id.'/edit'); }}" role="button">Editar</a>
