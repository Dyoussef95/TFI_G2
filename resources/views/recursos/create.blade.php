  ...
  <div class="container d-flex flex-column align-items-stretch flex-shrink-0 bg-dark text-white">
    ...
    <div class="scrollarea">
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Crear Nuevo Recurso</h4>
        <a class="btn btn-success btn-sm" href="{{ url('/recursos'); }}" role="button">Volver</a>
        <form action="{{ url('/recursos'); }}" method="POST">
        @csrf

           
              <label for="firstName" class="form-label">Nombre del Recurso</label>
              <input type="text" class="form-control" id="firstName" name="descripcion" placeholder="" value="" required>
             
          <hr class="my-4">

          <button class="w-100 btn btn-primary btn-lg" type="submit">Crear Recurso</button>
        </form>
        <br>
      </div>
