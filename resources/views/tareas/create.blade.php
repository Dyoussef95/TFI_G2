  ...
  <div class="container d-flex flex-column align-items-stretch flex-shrink-0 bg-dark text-white">
    ...
    <div class="scrollarea">
      <div class="col-md-7 col-lg-8">
        ...
        <form action="{{ url('/proyectos/'.$proyecto->id.'/tareas'); }}" method="POST">
        @csrf
          ...
          <div class="row g-3">
              ...
              <input type="number" class="form-control" id="firstName" name="gradoAvance" placeholder="" value="" required>
              </div>
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Crear Tarea</button>
        </form>
        <br>
      </div>
