  ...
  <div class="container d-flex flex-column align-items-stretch flex-shrink-0 bg-dark text-white">
    ...
    <div class="scrollarea">
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Agregar Recurso</h4>
        <a class="btn btn-success btn-sm" href="{{ url('/proyectos'); }}" role="button">Volver</a>
        <form action="{{ url('/tareas/'.$tarea->id.'/recursos'); }}" method="POST">
        @csrf

          <div class="row g-3">

              <div class="col-12">
              <select class="form-select" aria-label="Default select example" name="idRecurso" required>
              ...
              <input type="number" class="form-control" id="firstName" name="costo" placeholder="" value="" required>

          </div>
          <hr class="my-4">

          <button class="w-100 btn btn-primary btn-lg" type="submit">Agregar Recurso</button>
        </form>
        <br>
      </div>
